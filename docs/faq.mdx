...
a. When request to api.abfinance.com or stream.abfinance.com, make sure the API key is created from [Production](https://www.abfinance.com)
...
```
---
b. When request to `api-demo.abfinance.com` or `stream-demo.abfinance.com`, make sure the API key is created from [Production](https://www.abfinance.com) – **while in Demo Trading mode**
...
```
---
c. When request to `api-testnet.abfinance.com` or `stream-testnet.abfinance.com`, make sure the API key is created from [Testnet](https://testnet.abfinance.com) – **while outside of Demo Trading mode**
![test](/img/test.png)
```python
# pybit example
session = HTTP(
