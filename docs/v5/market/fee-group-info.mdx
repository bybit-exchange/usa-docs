...
Query for the [group fee structure](https://www.abfinance.com/en/help-center/article/Group-Fee-Structure-Symbol-Grouping) and fee rates.

:::note
The new grouped fee structure only applies to Pro-level and Market Maker clients. It does not apply to retail traders.
:::

For more details please refer to the [fee structure update announcement](https://announcements.abfinance.com/article/bybit-fee-structure-update-for-pro-and-market-maker-clients-blt06875b6d623e7581/).
