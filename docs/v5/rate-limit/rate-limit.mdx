...
<table border="0.8">
    ...
    <tr>
        <th colSpan="4" align="center">spot</th>
    </tr>
    <tr>
        <td rowSpan="8">POST</td><td>/v5/order/create</td><td colSpan="4" align="center">20/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/amend</td><td colSpan="4" align="center">10/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/cancel</td><td colSpan="4" align="center">20/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/cancel-all</td><td colSpan="4" align="center">20/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/create-batch</td><td colSpan="4" align="center">20/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/amend-batch</td><td colSpan="4" align="center">20/s</td><td align="center">Y</td>
    </tr>
    <tr>
        <td>/v5/order/cancel-batch</td><td colSpan="4" align="center">20/s</td><td align="center">Y</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>/v5/order/spot-borrow-check</td><td colSpan="4" align="center">50/s</td><td align="center">N</td>
    </tr>
</table>
</span>
...
<table border="0.8">
    ...
    <tr>
        <td rowSpan="13">GET</td><td>/v5/account/wallet-balance</td><td>accountType=UNIFIED</td><td>50/s</td><td align="center">N</td>
    </tr>
    <tr>
...
is 100/s, so in this case, I can place 200 orders in one second if I use both endpoints to place orders*
