...
|> cumExecFee |string |<li>`spot`: Deprecated. Use `cumFeeDetail` instead.</li><li>After upgraded to the Unified account, you can use `execFee` for each fill in [Execution](execution) topic</li> |
