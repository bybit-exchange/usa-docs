...
a. 當請求到api.abfinance.com或者stream.abfinance.com時, 請確保api key創建自[主網](https://www.abfinance.com)
![主網示意圖](/img/prd.png)
```python
# pybit示例
session = HTTP(
...
```
---
b. 當請求到api-demo.abfinance.com或者stream-demo.abfinance.com時, 請確保api key創建自[主網](https://www.abfinance.com)的"模擬交易"服務
...
```
---
c. 當請求到api-testnet.abfinance.com或者stream-testnet.abfinance.com時, 請確保api key創建自[測試網](https://testnet.abfinance.com)
![測試網示意圖](/img/test.png)
```python
# pybit示例
session = HTTP(
...
使用母帳戶登錄後, 進入到該[頁面](https://testnet.abfinance.com/user/assets/home/overview), 右邊有個"申請測試幣"按鈕
