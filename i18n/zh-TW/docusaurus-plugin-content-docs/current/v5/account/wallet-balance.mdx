...
:::info
* 在UTA手動借貸新邏輯下，現貨負債對應的`spotBorrow`, 請詳見<a href="https://announcements.abfinance.com/en/article/bybit-uta-function-optimization-manual-coin-borrowing-will-be-launched-soon-blt5d858199bd12e849/">公告</a>.
...
|>> spotBorrow |string |現貨槓桿交易借入金額以及手工借貸金額（不包含現貨槓桿活躍訂單借入金額）。現貨負債對應的`spotBorrow`, 請詳見<a href="https://announcements.abfinance.com/en/article/bybit-uta-function-optimization-manual-coin-borrowing-will-be-launched-soon-blt5d858199bd12e849/">公告</a>. |
