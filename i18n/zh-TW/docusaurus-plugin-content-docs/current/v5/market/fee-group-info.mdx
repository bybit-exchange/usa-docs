...
查詢[分組手續費結構](https://www.abfinance.com/en/help-center/article/Group-Fee-Structure-Symbol-Grouping)相關信息及費率

:::note
新的分組費率結構僅適用於專業級別和做市商客戶, 不適用於散戶交易者
:::

更多詳情請參考[費率結構更新公告](https://announcements.abfinance.com/article/bybit-fee-structure-update-for-pro-and-market-maker-clients-blt06875b6d623e7581/)
...
| [groupId](../enum#groupid) | false    | string | 分組ID, `1`, `2`, `3`, `4`, `5`, `6`, `7` |
